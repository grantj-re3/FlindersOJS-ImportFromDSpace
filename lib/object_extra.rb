#--
# Copyright (c) 2013-2017, Flinders University, South Australia. All rights reserved.
...
class String
  ...
  # Predefined entities in XML for ruby 1.8.7.
  #  Simulate *part* of the functionality of ruby >= 1.9.1:
  # - s.encode(:xml => :text)
  # - s.encode(:xml => :attr)
  def encode2(opts={})
    xml_entity_lookup = [
    ...
    if opts[:xml] == :text
      xml_entity_lookup.inject(self){|s,(regex, subst)| s.gsub(regex, subst)}
